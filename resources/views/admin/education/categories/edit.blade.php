                    ...
                    <div class="row g-3">
                        <div class="col-md-5">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="icon" id="iconInput" class="form-control @error('icon') is-invalid @enderror" value="{{ old('icon', $category->icon) }}" placeholder="e.g. graph-up" maxlength="50">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control font-monospace" value="{{ old('color', $category->color) }}" maxlength="7" id="colorText" oninput="document.getElementById('colorPicker').value=this.value">
                            </div>
